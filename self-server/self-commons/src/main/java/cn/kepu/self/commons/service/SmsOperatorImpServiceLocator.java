...
public class SmsOperatorImpServiceLocator extends org.apache.axis.client.Service implements cn.kepu.self.commons.service.SmsOperatorImpService {
    ...
    public cn.kepu.self.commons.service.ISmsOperator getSmsOperatorImpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.kepu.self.commons.service.SmsOperatorImpServiceSoapBindingStub _stub = new cn.kepu.self.commons.service.SmsOperatorImpServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.kepu.self.commons.service.ISmsOperator.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.kepu.self.commons.service.SmsOperatorImpServiceSoapBindingStub _stub = new cn.kepu.self.commons.service.SmsOperatorImpServiceSoapBindingStub(new java.net.URL(SmsOperatorImpPort_address), this);
                _stub.setPortName(getSmsOperatorImpPortWSDDServiceName());
                return _stub;
            }
        }
