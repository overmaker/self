...
public class MtMessageRes  implements java.io.Serializable {
    private cn.kepu.self.commons.service.MtMessageResDetail[] resDetail;
    ...
    public MtMessageRes(
           cn.kepu.self.commons.service.MtMessageResDetail[] resDetail,
     ...
     * @return resDetail
     */
    public cn.kepu.self.commons.service.MtMessageResDetail[] getResDetail() {
        return resDetail;
    }
     ...
     * @param resDetail
     */
    public void setResDetail(cn.kepu.self.commons.service.MtMessageResDetail[] resDetail) {
        this.resDetail = resDetail;
    }

    public cn.kepu.self.commons.service.MtMessageResDetail getResDetail(int i) {
        return this.resDetail[i];
    }

    public void setResDetail(int i, cn.kepu.self.commons.service.MtMessageResDetail _value) {
