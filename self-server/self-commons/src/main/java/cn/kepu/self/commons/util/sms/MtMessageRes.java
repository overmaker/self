...
public class MtMessageRes  implements java.io.Serializable {
    private cn.kepu.self.commons.util.sms.MtMessageResDetail[] resDetail;
    ...
    public MtMessageRes(
           cn.kepu.self.commons.util.sms.MtMessageResDetail[] resDetail,
     ...
     * @return resDetail
     */
    public cn.kepu.self.commons.util.sms.MtMessageResDetail[] getResDetail() {
        return resDetail;
    }
     ...
     * @param resDetail
     */
    public void setResDetail(cn.kepu.self.commons.util.sms.MtMessageResDetail[] resDetail) {
        this.resDetail = resDetail;
    }

    public cn.kepu.self.commons.util.sms.MtMessageResDetail getResDetail(int i) {
        return this.resDetail[i];
    }

    public void setResDetail(int i, cn.kepu.self.commons.util.sms.MtMessageResDetail _value) {
