((window, $, layer, SELF) => {
    SELF.registeredPopup("advertisement-upload", "module/advertisement/advertisement-upload.html");
    var titleType;
    let [dialog,
        titleTextbox,
...
if (titleType === "activity") {
    ...
    loadProductList(currentPageNumber, currentPageSize, searchTitle);
        ...
        return new window.Promise((resolve, reject) => {
            ...
            xhr.open("POST", `/admin/advertisement`);
            xhr.setRequestHeader("Content-Type", "application/json");
            xhr.send(JSON.stringify(obj));
        });
    };

    SELF.subscribe("advertisement-upload", () => {
        initUI();
    });
})(this, $, layer, SELF);